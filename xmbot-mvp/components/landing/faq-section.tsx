...
const faqs = [
  ...
  { question: "What is XMOne?", answer: "XMOne is an AI-powered investment platform for gold, stocks, crypto, and mutual funds. It uses a multi-agent system to analyze markets 24/5 and sends trading signals to your Telegram. You approve or reject each trade — no auto-execution without your say." },
  ...
  { question: "What about mutual funds?", answer: "XMOne provides AI-powered mutual fund recommendations for Indian investors. Based on your risk profile and goals, we suggest direct plan options across equity, debt, and hybrid categories." },
  { question: "How is this different from other trading bots?", answer: "Most bots trade automatically without your input. XMOne requires human approval for every trade. We also use a multi-agent architecture (not just simple indicators), AI validation, and support multiple markets and asset classes." },
]
